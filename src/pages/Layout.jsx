        ...
        <header className="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-stone-50 text-sm py-4 dark:bg-neutral-800">
          <nav className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
            <div className="flex items-center justify-between">
              <a className="flex-none text-xl font-semibold dark:text-white" href="/"><span className='px-2 py-1 border-2 mr-1 border-black rounded-xl'>shadcn/ui</span> Not2Flat v1</a>
