...
const ButtonCodeCustomSnippet = () => {
  ...
  const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-md",
    {
      variants: {
        variant: {
          default: "bg-gradient-to-t from-primary to-primary/70 shadow shadow-primary/40 text-primary-foreground hover:bg-primary/90",
          destructive:
  ...
  return (
    <div className="p-2 bg-gray-100 w-full text-xs">
      <pre className="whitespace-pre-wrap bg-stone-100 p-4 rounded-lg border border-gray-300">
        {code}
      </pre>
...
export default ButtonCodeCustomSnippet;
