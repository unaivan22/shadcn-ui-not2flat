...
export default function ButtonSection() {
  ...
  useEffect(() => {
    ...
    fetch('https://raw.githubusercontent.com/unaivan22/shadcn-ui-not2flat/master/src/components/ui/button.jsx')
      ...
      <Layout>
        <div className='container mx-auto px-0 md:px-24 mt-12'>
          <div className='flex flex-col gap-y-2 mb-12'>
            ...
            <div className='flex items-center justify-center h-[60vh] border rounded-md w-full'>
