...
import { ArrowUpRight, Calendar, Copy} from "lucide-react"
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
...
export default function HoverCardSection() {
  ...
  useEffect(() => {
    ...
    fetch('https://raw.githubusercontent.com/unaivan22/shadcn-ui-not2flat/refs/heads/master/src/components/ui/hover-card.jsx')
